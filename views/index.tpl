...
<div class=" container-fluid header-main header-section">
    ...
    <div class="container container-zindex container-index">
        <img class="img-responsive" src="/static/img/showcase-header.png" about="" alt="">
        <h1>移动公关第一品牌</h1>
...
<div class="container marketing">
    <div class="row">
        <div class="col-lg-3">
            <img width="140" height="140" alt="Generic placeholder image" src="/static/img/pd/Spread.png" class="">
            <h2>社会化媒体传播</h2>
            <p>以落地活动为主要传播信息，定期将文字、图片及视频短片传到官方微信、微博进行传播。</p>
        </div><!-- 社会化媒体传播 -->
        <div class="col-lg-3">

            <img width="140" height="140" alt="Generic placeholder image" src="/static/img/pd/mobile.png" class="">
            <h2>移动互联网搭建</h2>
            <p>根据客户的需求，市场状况，企业情况等进行搭建适合客户的微信。 </p>
        </div><!-- 移动互联网搭建 -->
        <div class="col-lg-3">
            <img width="140" height="140" alt="Generic placeholder image" src="/static/img/pd/weixin.png" class="">
            <h2>微信全案营销</h2>
            <p>为企业量身定制独立的全案营销方案，全方位的为客户提供有效的解决方案。</p>
        </div><!-- 微信全案营销 -->

        <div class="col-lg-3">
            <img width="140" height="140" alt="Generic placeholder image" src="/static/img/pd/web.png" class="">
            <h2>定制项目开发</h2>
        ...
        <div class="col-md-5" >
            <div data-ride="carousel" class="carousel slide" id="myCarousel">
                <div role="listbox" class="carousel-inner">
                    <div class="item">
                        <img alt="First slide" src="/static/img/banner/banner.png" class="first-slide">
                    </div>
                    <div class="item active">
                        <img alt="Second slide" src="/static/img/banner/banner.png" class="second-slide">
                    </div>
                    <div class="item">
                        <img alt="Third slide" src="/static/img/banner/banner.png" class="third-slide">
                    </div>
                </div>
        ...
        <div class="row thumbnail-clear">
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.qunar.com/" target="_blank" title="去哪儿网" >
                    <img alt="100%x110" data-src="holder.js/100%x110" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h1.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.amazon.cn/" target="_blank" title="卓越亚马逊">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h2.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.cebbank.com/" target="_blank" title="光大银行">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h3.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.lexus.com.cn/" target="_blank" title="雷克萨斯">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h4.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.haval.cn/" target="_blank" title="哈佛网">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h5.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.yonyou.com/" target="_blank" title="用友yonyou">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h6.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.xiaoniu88.com/" target="_blank" title="小牛在线">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h7.png" data-holder-rendered="true">
                </a>
            </div>
            <div class="col-xs-6 col-md-3">
                <a class="thumbnail thumbnail-bottom" href="http://www.hzkywy.com/" target="_blank" title="开元物业">
                    <img alt="100%x180" data-src="holder.js/100%x180" style="height: 110px; width: 100%; display: block;" src="/static/img/code/h8.png" data-holder-rendered="true">
                </a>
            </div>
        </div>
    </div>
...
<footer class="main-footer  main-footer1">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <div class="widget">
                    <h4 class="title"><img src="/static/img/logo-blue.png"></h4>
                    <div class="content recent-post">
                        <div class="recent-single-post"><div class="date">QIANTUI移动公关第一品牌，我们拥有最全面的媒介数据库资源，我们能给您提供全面的服务 。</div></div>
                        <div class="recent-single-post"><a class="post-title" href="#">北京一通无限科技有限公司</a><div class="date" style="padding-top:10px;">Copyright © 2018 一通无限</div></div>
                    </div>
                </div>
            </div>
            <div class="col-sm-3 col-xs-6">
                <div class="widget">
                    ...
                    <div class="content-about">
                        ...
                        <div><a href="#" target="_blank">加入我们</a></div>
            ...
            <div class="col-sm-2 col-xs-12">
                <div class="widget">
                    <div class="content-about" >
                        <img src="/static/img/ewm.jpg" width="148" height="148" style="border:1px solid #eee; padding:5px;" title="扫描二维码。关注我们。">
                    </div>
                </div>
            </div>
        </div>
